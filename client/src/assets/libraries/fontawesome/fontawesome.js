...
(function() {
  ...
  var asSymbol = function(_ref) {
    ...
    var id =
      symbol === true
        ? prefix + "-" + config.familyPrefix + "-" + iconName
        : symbol;
  ...
  function observe(options) {
    ...
    var treeCallback = options.treeCallback,
      ...
      observeMutationsRoot =
        _options$observeMutat === undefined
          ? DOCUMENT.body
    ...
    if (config.autoA11y) {
      if (title) {
        extraAttributes["aria-labelledby"] =
          config.replacementClass + "-title-" + nextUniqueId();
      } else {
      ...
      toArray(root.querySelectorAll("*"))
        .filter(function(n) {
          return (
            ...
            !n.getAttribute(DATA_FA_PSEUDO_ELEMENT) &&
    ...
    return apiObject({ type: "text", content: content }, function() {
      ...
      return makeLayersTextAbstract({
        ...
        extra: {
          attributes: attributes,
          styles: styles,
          classes: [config.familyPrefix + "-layers-text"].concat(
    ...
    return apiObject({ type: "counter", content: content }, function() {
      ...
      return makeLayersCounterAbstract({
        ...
        extra: {
          attributes: attributes,
          styles: styles,
          classes: [config.familyPrefix + "-layers-counter"].concat(
            toConsumableArray(classes)
          )
        }
      });
  ...
  var autoReplace = function autoReplace() {
    ...
    var _params$autoReplaceSv = params.autoReplaceSvgRoot,
      autoReplaceSvgRoot =
        _params$autoReplaceSv === undefined ? DOCUMENT : _params$autoReplaceSv;

    if (
      Object.keys(namespace.styles).length > 0 &&
      IS_DOM &&
